...
namespace Risxpert
{
    ...
    public partial class Form_Risxpert : Form
    {
        ...
        */
        ...
        {
            using (var db = new LiteDatabase(@"C:\Programación\Programación para Mecatrónicos\PPM\Tarea 9\Risxpert program 1\Risxpert program\Risxpert\Data Base Lite DB Risxpert\Risxpert.db"))
            {
        ...
        */
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            //Crear una nueva instancia para la tabla 2
